    ...
    return (
        <div>
            <Title
                ...
                font='outfit'
                title='DashBoard'
                subTitle='Monitor your room listings, track bookings and analyze revenue—all in one place. Stay updated with real-time insight to ensure smooth operation.'
            />

            <div className='flex gap-4 my-8 flex-wrap'>
                {/* Total Bookings */}
                <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8 shadow-sm hover:shadow-md transition-shadow'>
                    ...
                    <table className='min-w-[600px] w-full'>
                        ...
                        <tbody>
                            {dashboardData.bookings.map((item, index) => (
                                <tr key={index} className={!item.isPaid ? 'bg-yellow-50' : ''}>
