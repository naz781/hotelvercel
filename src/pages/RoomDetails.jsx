...
const RoomDetails = () => {
    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] rounded-xl mx-auto mt-16 max-w-6xl p-4 md:p-6 lg:p-8 mb-20'>
                <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input type="number" id="guests" min='1' placeholder='0'
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>Guests will be comfortably accommodated on the ground floor based on availability. Our spacious two-bedroom apartment offers an authentic city-living experience, designed for both comfort and convenience. The quoted price includes two guests. To ensure accurate pricing for larger groups, please select the total number of guests in the booking form. Additional charges may apply based on guest count. We strive to make your stay relaxing and seamless, with easy ground-floor access for all confirmed guests.</p>
            </div>
            {/*Hosted By*/}
