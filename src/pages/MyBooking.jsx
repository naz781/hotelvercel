...
const MyBooking = () => {
    ...
    return (
        <div className='py-28 md:pb-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            <Title
                title="My Booking"
                subTitle="Easily manage your past, current, and upcoming hotel reservations in one place. Plan your trips in just a few clicks."
                align="left"
            />
            ...
            <div className='max-w-6xl mt-8 w-full text-gray-800'>
                ...
                {bookings.map((booking) => (
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] gap-6 border-b border-gray-300 py-6 first:border-t'>

                        {/* Hotel Info */}
                        <div className='flex items-start gap-4'>
                            <img src={booking.room.images[0]} alt="hotel-img" className="w-28 h-20 rounded-lg object-cover shadow" />
                            <div>
